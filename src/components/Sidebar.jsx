...
function Sidebar({ profileIs, setProfileIs }) {
  const handleProfile = () => {
    setProfileIs(true);
  };
  const handleHome = () => {
    ...
    <div className="sidebar_container">
      <div className="sidebar">
        ...
        <div className="navlinks">
          <div className="home navlink" onClick={handleHome}>
            <svg
              viewBox="0 0 24 24"
              aria-hidden="true"
          ...
          <div className="profile navlink" onClick={handleProfile}>
            <svg
              viewBox="0 0 24 24"
              aria-hidden="true"
              className="r-1nao33i r-4qtqp9 r-yyyyoo r-lwhw9o r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-cnnz9e"
          ...
          <div className="sidebar_tweet">
            <Link to="/tweet">
              <button>
                <svg
                  viewBox="0 0 24 24"
                  aria-hidden="true"
                  className="r-jwli3a r-4qtqp9 r-yyyyoo r-1472mwg r-1kb76zh r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-lrsllp"
                >
                  <g>
          ...
          <div className="sidebar_tweet">
            <button className="signOut_btn mt-1" onClick={() => auth.signOut()}>
              <svg
                viewBox="0 0 24 24"
